    ...
    <body>
        ...
        <header style="z-index: 2">
            ...
            <nav class="navbar navbar-expand-lg navbar-light menu" style="background-color: #1C6C9D;">
                ...
                <a class="navbar-brand" style="color: white;" href="index.html">Compras</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                          ...
                          <li class="nav-item dropdown">
                            <a class="nav-link" href="actvo_fijo.html" style="color: white"> 
                                Activo fijo
                            </a>
                          </li>
        ...
        <div class="container-fluid contenido">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="background-color: #1C6C9D">
                    ...
                    <div style="background-color: white" >
                        ...
                        <input type="text" name="id_cliente" id="id_cliente" 
                               placeholder="Número cliente" pattern="[0-9]{7}"
                       ...
                       <input type="submit" name="Buscar" id="Buscar" 
                              ...
                              class="btn btn-light" value="Agregar proveedor" o/>
                       <br>
                       <br>
                       <input type="submit" name="Buscar" id="Buscar" 
                              style="background-color: #37A1FF; color: white" 
                              class="btn btn-light" value="Modificar proveedor" o/>
                        <br>
                        <br>
                        <input type="submit" name="Buscar" id="Buscar" 
                              style="background-color: #37A1FF; color: white" 
                              class="btn btn-light" value="Eliminar proveedor" o/>
                        <br>
                        <br>
               ...
               <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                   <center>
                   <img src="../Complementos/Imagenes/proveedores.PNG" alt=""/>
                   </center>
               </div>
                        ...
                        <form>
                            ...
                            <center>
                                <label style="font-size: 18px" >
                                    &Aacute;rea: Proveedores&nbsp;&nbsp;&nbsp;&nbsp;
                                </label>
                                <br>
                                <img src="../Complementos/Imagenes/descraga.png" alt=""/>
                                <br>

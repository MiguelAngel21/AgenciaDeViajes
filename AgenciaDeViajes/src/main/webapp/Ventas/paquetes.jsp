        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="background-color: #1C6C9D">
                    ...
                    <div style="background-color: white" >
                        ...
                        <input type="text" name="id_cliente" id="id_cliente" 
                               placeholder="Número de paquete" pattern="[0-9]{7}"
                      ...
                      <br>
                       ...
                       <button type="button" name="agregaProd" data-toggle="modal" data-target="#agregar" 
                                   style="background-color: #37A1FF; color: white" class="btn btn-light">
                                        Agregar Paquete
                           </button>
                       <br>
                       <br>
                       <button type="button" name="agregaProd" data-toggle="modal" data-target="#modificar" 
                                   style="background-color: #37A1FF; color: white" class="btn btn-light">
                                        Modificar Paquete
                           </button>
                        <br>
                        <br>
                        <button type="button" name="agregaProd" data-toggle="modal" data-target="#eliminar" 
                                   style="background-color: #37A1FF; color: white" class="btn btn-light">
                                        Eliminar Paquete
                           </button>
                        <br>
              ...
              <div class="modal-body">
                <div class="form-style-5">
                        ...
                        <span><input type="text" required="required"/></span>
                          <br>
                          <br>
                          &nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-default" data-dismiss="modal" style="background-color:#37A1FF; color: white ">Agregar servicio</button>&nbsp;&nbsp;&nbsp;&nbsp;
                        <br>
                        <br>
                        <span>Fecha de inicio:    </span><span><input  type="date" name="fecha" id="fecha"/></span>
                        <br>
                        <br>
                        <span>Fecha final:    </span><span><input  type="date" name="fecha" id="fecha"/></span>
                        <br>
                        <br>
                        <br>
                        <br>
